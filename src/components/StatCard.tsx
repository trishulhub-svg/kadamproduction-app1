...
const TONES: Record<string, string> = {
  primary: "glass bg-gradient-to-br from-blue-500/20 to-blue-600/10 text-blue-900 dark:text-blue-100 border border-blue-200/40 dark:border-blue-800/30",
  ...
  secondary: "glass bg-gradient-to-br from-gray-500/20 to-gray-600/10 text-gray-900 dark:text-gray-100 border border-gray-200/40 dark:border-gray-700/30",
  dark: "glass bg-gradient-to-br from-gray-800/30 to-gray-900/20 text-gray-900 dark:text-gray-100 border border-gray-300/30 dark:border-gray-700/30",
  purple: "glass bg-gradient-to-br from-purple-500/20 to-purple-600/10 text-purple-900 dark:text-purple-100 border border-purple-200/40 dark:border-purple-800/30",
};
